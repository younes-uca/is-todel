...
@Component({
  selector: 'app-facture-charge-edit-admin',
  templateUrl: './facture-charge-edit-admin.component.html'
})
export class FactureChargeEditAdminComponent extends AbstractEditController<FactureChargeDto, FactureChargeCriteria, FactureChargeService>   implements OnInit {
    ...
    public prepareEdit() {
        this.item.dateFacuture = this.factureChargeService.format(this.item.dateFacuture);
    }
